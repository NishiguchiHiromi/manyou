...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post labels_url, params: { label: { name: @label.name, task_id: @label.task_id, user_id: @label.user_id } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { name: @label.name, task_id: @label.task_id, user_id: @label.user_id } }
